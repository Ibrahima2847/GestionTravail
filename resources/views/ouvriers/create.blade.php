...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('gest_ouvrier')}}">Retour</a>
        </div>
    </div>
</div>
            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Ajouter un Ouvrier</p>

                  <form class="mx-1 mx-md-4" action="{{route('ouvriers')}}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        <div class="form-outline flex-fill mb-0">
                          <input type="hidden" id="form3Example4cd" class="form-control" value="ouvrier"  name="profil"/>
                        </div>
                      </div>
