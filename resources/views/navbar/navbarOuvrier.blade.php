        ...
        >
          <div class="py-4 text-gray-500 dark:text-gray-400" style="background-color: #585858; height:100%; ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a class=" nav-link text-white"  {{'enCour' == request()->path() ? 'active' : ''}} aria-current="page" href="{{route('enCour')}}">
                        <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                      <span class="ml-4" style="font-size: 20px">Travail en cour</span>
                    </a>
                </li>
                <li>
                    <a class=" nav-link text-white"  {{'enCour' == request()->path() ? 'active' : ''}} aria-current="page" href="{{route('terminer')}}">
                        <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                      <span class="ml-4" style="font-size: 20px">Travail terminer</span>
                    </a>
                </li>
                <li>
                    <a class=" nav-link text-white"  {{'enCour' == request()->path() ? 'active' : ''}} aria-current="page" href="{{route('changer')}}">
                        <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                      <span class="ml-4" style="font-size: 20px">Mot de passe</span>
                    </a>
                </li>
                <li>
                    <a class=" nav-link text-white"  {{'enCour' == request()->path() ? 'active' : ''}} aria-current="page" href="{{route('metier')}}">
                        <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                ...
                <li>
                    {{-- <a class=" nav-link text-white"  {{'enCour' == request()->path() ? 'active' : ''}} aria-current="page" href="{{route('disponibilite')}}">
                        <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                      <span class="ml-4" style="font-size: 20px">Ma disponibilite</span>
                    </a> --}}
                </li>
            </ul>
            <div class="px-6 my-6">
