      ...
      >
        ...
        >
          <div class="py-4 text-gray-500 dark:text-gray-400" style="background-color: #585858; height:100%;">
            ...
            <div class="d-flex flex-column flex-shrink-0 text-white" style="width:100%; margin-left:2%; margin-top:1px; margin-bottom:1px">
                <img src="{{ asset('./assets/img/logo2.png')}}" class="align-items-center me-md-auto text-white text-decoration-none" alt="">
                {{-- <a href="/" > --}}
                  {{-- <svg class="bi me-2" width="4" height="3px"><use xlink:href="#bootstrap"/></svg> --}}
                  {{-- <span class="fs-4">KayJob</span> --}}
                {{-- </a> --}}
            </div>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a class=" nav-link text-white" href="{{route('gererToutAnnonce')}}">
                  <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                  <span class="ml-4" style="font-size: 20px">Gérer les annonces</span>
                </a>
              </li>
              <li>
                <a class=" nav-link text-white" href="{{route('indexAgent')}}">
                  <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                  <span class="ml-4" style="font-size: 20px">Mise en relation</span>
                </a>
              </li>
              <li>
                <a class=" nav-link text-white" href="{{route('relationEnCour')}}">
                    <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
                  <span class="ml-4" style="font-size: 20px">Relation en cour</span>
                </a>
              </li>
              <li>
                <a href="{{route('annonceTerminer')}}" class=" nav-link text-white">
                    <svg class="bi me-2" width="16" height="11"><use xlink:href="#speedometer2"/></svg>
            ...
            {{-- <div class="px-6 my-6">
              ...
              href="{{route('accueil')}}"   style="background-color: #e21111">
                Accueil
            </a>
            </div> --}}
          </div>
